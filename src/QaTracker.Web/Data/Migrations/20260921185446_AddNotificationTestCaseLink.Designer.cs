...
namespace QaTracker.Web.Data.Migrations
{
    ...
    [Migration("20260921185446_AddNotificationTestCaseLink")]
    partial class AddNotificationTestCaseLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QaTracker.Web.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("ProjectListFilter")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ApplicationUserProject", b =>
                {
                    ...
                    b.HasOne("QaTracker.Web.Projects.Project", null)
                        .WithMany()
